...
from app.api import chat, collections, history, knowledge, search, uploads
...
for router in (chat.router, collections.router, history.router, knowledge.router, search.router, uploads.router):
