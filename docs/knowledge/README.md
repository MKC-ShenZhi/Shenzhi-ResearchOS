...
| `apps/backend/app/services/paper_resource/service.py` | PDF Provider 选择、资源编排与 fallback 决策 |
| `apps/backend/app/integrations/paper_resource/` | OpenReview URL 适配、外部 HTTP streaming 与资源校验 |
