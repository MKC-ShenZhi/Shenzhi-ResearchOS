...
| `lib/c-server/parse-document.ts`、`app/api/uploads/route.ts` | FastAPI `services/uploads/parser.py`、`services/chat/attachments.py`、`api/_support/upload_reader.py`、`api/uploads.py` | PDF/TXT/Markdown、20MB、不落盘、30k/60k、截断 warning |
